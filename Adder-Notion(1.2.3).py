# -*- coding: utf-8 -*-
"""
Created on Wed Sep  4 17:41:49 2024
...
def updatePageNoDate(headers, nthTask, percentToday, newTitle, url, percentComplete, status):
    updateUrl = url
    print(updateUrl)
    updateData = {
        "properties": {
...
if len(orderedList) < 10:
    print("")
    for i in range(len(orderedList), 10):
        newName = " "
        ...
        dayToComplete = "All Unfinished"
        
        
        
        updatePageNoDate(headers, i, percentToComplete, newName, urlList[i], percentCompleted, dayToComplete)
